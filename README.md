...
function openRealEstatePage(name) {
  ...
  realEstatePage.className = 'real-estate-page';
  realEstatePage.innerHTML = renderRealEstatePage(item);
  document.body.appendChild(realEstatePage);
  addRealEstatePageStyles();
  scrollToTop();
}

function renderRealEstatePage(property) {
  const headerHTML = `
    <div class="real-estate-header">
  ...
  const imageCarouselHTML = property.details.images && property.details.images.length > 0 ? `
    <div class="real-estate-image-carousel">
      ${property.details.images.map((image, index) => `
        <div class="real-estate-carousel-item ${index === 0 ? 'active' : ''}">
          <img src="${image}" alt="${property.details.name}" onclick="openFullScreen('${image}')">
        </div>
      `).join('')}
      <div class="real-estate-carousel-pagination">
        ${property.details.images.map((_, index) => `
          <div class="real-estate-pagination-dot ${index === 0 ? 'active' : ''}" onclick="currentRealEstateSlide(${index + 1}); event.stopPropagation()"></div>
        `).join('')}
      </div>
      <button class="real-estate-carousel-control prev" onclick="changeRealEstateSlide(event, -1); event.stopPropagation()">&#10094;</button>
      <button class="real-estate-carousel-control next" onclick="changeRealEstateSlide(event, 1); event.stopPropagation()">&#10095;</button>
    </div>
  ` : `
    <div class="real-estate-image-container">
      <img src="${property.details.image}" alt="${property.details.name}" class="real-estate-image">
    </div>
  `;
  ...
  return `
    ...
    <div class="real-estate-content">
      ...
      <!-- Description Section -->
      <div class="real-estate-description-section">
        <h3>Property Details</h3>
        <p>${property.details.description}</p>
      </div>
      
      <!-- Specifications Section -->
      <div class="real-estate-specs-section">
      ...
      <!-- Amenities Section -->
      <div class="real-estate-amenities-section">
        <h3>Amenities</h3>
      ...
      <!-- Location Section -->
      <div class="real-estate-location-section">
        <h3>Location</h3>
        <div class="location-info">
          <div class="address">
            <i class="fas fa-map-marker-alt"></i>
...
function addRealEstatePageStyles() {
  ...
  style.textContent = `
    ...
    .real-estate-carousel-item.active {
      opacity: 1;
      transform: scale(1);
    }

    .real-estate-carousel-item img {
      width: 100%;
      height: 100%;
      object-fit: cover;
      transition: transform 0.4s ease;
    ...
    .real-estate-image-carousel:hover .real-estate-carousel-item.active img {
      transform: scale(1.05);
    }

    .real-estate-carousel-control {
      position: absolute;
      top: 50%;
      transform: translateY(-50%);
      background: rgba(0, 0, 0, 0.6);
    ...
    .real-estate-image-carousel:hover .real-estate-carousel-control {
      opacity: 0.9;
    }

    .real-estate-carousel-control:hover {
      background: rgba(0, 0, 0, 0.85);
      transform: translateY(-50%) scale(1.1);
    }

    .real-estate-carousel-control:active {
      transform: translateY(-50%) scale(0.95);
    }

    .real-estate-carousel-control.prev {
      left: 12px;
    }

    .real-estate-carousel-control.next {
      right: 12px;
    }

    .real-estate-carousel-pagination {
      position: absolute;
      bottom: 12px;
      left: 0;
      right: 0;
    ...
    .real-estate-pagination-dot.active {
      background: #fff;
      width: 20px;
      border-radius: 4px;
      box-shadow: 0 0 6px rgba(255, 255, 255, 0.5);
    ...
    /* Description Section */
    .real-estate-description-section {
      padding: 0 20px 20px;
      border-bottom: 1px solid rgba(255, 255, 255, 0.1);
    }

    .real-estate-description-section h3 {
      margin: 0 0 12px;
      font-size: 1.2em;
      font-weight: 600;
    }

    .real-estate-description-section p {
      margin: 0;
      line-height: 1.6;
      color: rgba(255, 255, 255, 0.8);
    }
    ...
    /* Amenities Section */
    .real-estate-amenities-section {
      padding: 20px;
      border-bottom: 1px solid rgba(255, 255, 255, 0.1);
    }

    .real-estate-amenities-section h3 {
      margin: 0 0 16px;
      font-size: 1.2em;
      font-weight: 600;
    }
    ...
    /* Location Section */
    .real-estate-location-section {
      padding: 20px;
      border-bottom: 1px solid rgba(255, 255, 255, 0.1);
    }

    .real-estate-location-section h3 {
      margin: 0 0 16px;
      font-size: 1.2em;
      font-weight: 600;
    }
...
// Carousel functions for real estate page
function changeRealEstateSlide(event, direction) {
  event.stopPropagation();
  const carousel = event.target.closest('.real-estate-image-carousel');
  if (!carousel) return;

  const items = carousel.querySelectorAll('.real-estate-carousel-item');
  const dots = carousel.querySelectorAll('.real-estate-pagination-dot');
  let activeIndex = -1;
...
function currentRealEstateSlide(index) {
  const carousel = event.target.closest('.real-estate-image-carousel');
  if (!carousel) return;
